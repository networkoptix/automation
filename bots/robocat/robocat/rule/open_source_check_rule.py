...
class PreviousOpenSourceCheckResults:
    ERROR_MESSAGE_IDS = {
    ...
    def have_error(self, error: FileError) -> bool:
        return any([n for n in self._error_notes() if error == FileError(**n.additional_data)])
